    ...
    override fun translateTextToConlang(language: LanguageEntity, text: String): String {
        ...
        synchronized(language) {
                ...
                if (letter == ' ') {
                    ...
                    if (curWord != "") {
                        ...
                        var translation = if (prevWord2 == "" || prevWord1 == "") "" else {
                            try {
                                helper.translateWordToConlang(language, collocation)
                            } catch (e: WordNotFoundException) {
                                ""
                            }
                        }
                        ...
                        if (translation.isNotEmpty()) {
                            if (prevWord1.isNotEmpty() && prevWord1[0].isUpperCase()) translation =
                                helper.capitalizeWord(translation)
                            var translatedDelimiter = ""
                            translatedDelimiter = if (language.puncSymbols.containsKey(curDelimiter)) {
                        ...
                        if (translation.isEmpty()) {
                            ...
                            if (translation.isNotEmpty()) {
                                if (prevWord2.isNotEmpty() && prevWord2[0].isUpperCase()) translation =
                                    helper.capitalizeWord(translation)
                                if (prevWord1 != "") {
                                    val translatedDelimiter1 = if (language.puncSymbols.containsKey(prevDelimiter1)) {
                                        language.puncSymbols[prevDelimiter1]!!
                                    } else prevDelimiter1
                                    res += "$prevTranslation1$translatedDelimiter1 "
                                }
                                val translatedDelimiter = if (language.puncSymbols.containsKey(curDelimiter)) {
                                    language.puncSymbols[curDelimiter]!!
                                } else curDelimiter
                                res += "$translation$translatedDelimiter "
                                prevWord1 = ""
                        ...
                        if (translation.isEmpty()) {
                            ...
                            translatedWord = try {
                                Log.d("word", "word: $curWord")
                                translatedWord = helper.translateWordToConlang(language, curWord)
                                if (curWord[0].isUpperCase()) translatedWord =
                                    helper.capitalizeWord(translatedWord)
                                translatedWord
                            } catch (e: WordNotFoundException) {
                    ...
                    Log.d("meow2", "$curWord;$prevWord1,$prevTranslation1;$prevWord2,$prevTranslation2")
                    Log.d("cur res", res)
                    continue
                }
            ...
            if (prevWord2 != "") {
                ...
                val translatedDelimiter2 = if (language.puncSymbols.containsKey(prevDelimiter2)) {
